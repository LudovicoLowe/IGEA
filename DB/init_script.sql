...
CREATE TABLE `accesso` (
  ...
  CONSTRAINT `fk_accesso_dipendente` FOREIGN KEY (`id_dipendente`) REFERENCES `dipendente` (`id_dipendente`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `contratto` (
  ...
  CONSTRAINT `fk_contratto_dipendente` FOREIGN KEY (`id_dipendente`) REFERENCES `dipendente` (`id_dipendente`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO `dipendente` VALUES (1,10,1,'Sergio','Mattarella','xxx','666','sergio_666@hell.dio','da qualche parte in Ontario'),(2,10,2,'Michel','Jackson','yyy','333','michel_white_man@jack.dio','da qualche parte in Purgatorio'),(3,10,3,'Gino','Paoli','zzz','111','giggino@p.dio','da qualche parte in Molise');
...
CREATE TABLE `fornitore` (
  ...
  `p_iva` varchar(13) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `paziente` (
  ...
  `diagnosi` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `prenotazione` (
  ...
  KEY `fk_prenotazione_paziente_idx` (`id_paziente`),
  KEY `fk_prenotazione_ricetta_idx` (`id_ricetta`),
  KEY `fk_prenotazione_dipendente_idx` (`id_dipendente`),
  KEY `fk_prenotazione_fascia_oraria_idx` (`id_fascia_oraria`),
  CONSTRAINT `fk_prenotazione_dipendente` FOREIGN KEY (`id_dipendente`) REFERENCES `dipendente` (`id_dipendente`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_prenotazione_fascia_oraria` FOREIGN KEY (`id_fascia_oraria`) REFERENCES `fascia_oraria` (`id_fascia_oraria`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_prenotazione_paziente` FOREIGN KEY (`id_paziente`) REFERENCES `paziente` (`id_paziente`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_prenotazione_ricetta` FOREIGN KEY (`id_ricetta`) REFERENCES `ricetta` (`id_ricetta`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ricetta` (
  ...
  `id_tipo_esame` int(11) DEFAULT NULL,
  ...
  KEY `fk_ricetta_tipo_visita_idx` (`id_tipo_visita`),
  KEY `fk_ricetta_tipo_esame_idx` (`id_tipo_esame`),
  CONSTRAINT `fk_ricetta_tipo_esame` FOREIGN KEY (`id_tipo_esame`) REFERENCES `tipo_esame` (`id_tipo_esame`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_ricetta_tipo_visita` FOREIGN KEY (`id_tipo_visita`) REFERENCES `tipo_visita` (`id_tipo_visita`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ricovero` (
  ...
  `data_dimissione` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `dimmesso` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `tipo_esame` (
  ...
  KEY `fk_tipo_esame_reparto_idx` (`id_reparto`),
  CONSTRAINT `fk_tipo_esame_reparto` FOREIGN KEY (`id_reparto`) REFERENCES `reparto` (`id_reparto`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipo_visita` (
  `id_tipo_visita` int(11) NOT NULL AUTO_INCREMENT,
  `tipo` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `id_reparto` int(11) NOT NULL,
  PRIMARY KEY (`id_tipo_visita`),
  KEY `fk_tipo_visita_reparto_idx` (`id_reparto`),
  CONSTRAINT `fk_tipo_visita_reparto` FOREIGN KEY (`id_reparto`) REFERENCES `reparto` (`id_reparto`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tipo_visita`
--

LOCK TABLES `tipo_visita` WRITE;
/*!40000 ALTER TABLE `tipo_visita` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipo_visita` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-07-26 17:46:02
